...
import com.andreas.projekuts.AddFragment;
...
public class TambahEditBuku extends Fragment {
    ...
    private Button btnSimpan, btnBatal, btnUnggah, btnBack;
    private String status, selected,test;
    private int idBuku;
    private Buku buku;
    private View view;
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == 1)
        {
            ...
            test = Base64.encodeToString(ba, Base64.DEFAULT);
        }
        ...
        StringRequest  stringRequest = new StringRequest(PUT, BukuAPI.URL_UPDATE + idBuku, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams()
            {
                ...
                */
                ...
                params.put("namaBuku", namaBuku);
                params.put("pengarang", pengarang);
                params.put("harga", String.valueOf(0));
                if(test!=null)
                    params.put("gambar", test);
                return params;
